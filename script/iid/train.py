...
from src.dataset import BaseIIDDataset, DatasetMode, get_dataset
...
if "__main__" == __name__:
    ...
    parser = argparse.ArgumentParser(
        description="Marigold : Intrinsic Image Decomposition : Training"
    )
    parser.add_argument(
        "--config",
        type=str,
        default="config/train_marigold_iid.yaml",
    ...
    # Training dataset
    train_dataset: Union[BaseIIDDataset, List[BaseIIDDataset]] = get_dataset(
        cfg_data.train,
    ...
    model = MarigoldIIDPipeline.from_pretrained(
